    ...
    return (
        <div className='bg-[#161b1c]'>
            ...
            <div className='text-left mx-6 lg:mx-[300px] py-[50px]'>
                ...
                <div className='py-[40px]'>
                    <h3 className='pb-[25px]'>Compatibilidad de Dispositivos</h3>
                    <p>Mark App es compatible con una amplia gama de dispositivos, incluyendo computadoras, teléfonos y tabletas. Asegúrate de tener la última versión de la aplicación para disfrutar de todas las funciones en tu dispositivo preferido.</p>
                </div>
                <div className='py-[40px]'>
                    <h3 className='pb-[25px]'>Actualizaciones de funciones</h3>
                    <p>Mantente al día con las últimas actualizaciones y nuevas funciones de Mark App. Nuestro equipo trabaja constantemente para mejorar la aplicación y brindarte una experiencia aún mejor en la gestión de tus notas.</p>
                </div>
            </div>
        </div>
    )
