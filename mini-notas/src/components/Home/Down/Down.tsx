...
function AnimatedFromRight({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className='bg-[#effe8a] min-h-[900px] pt-10'>
            ...
            },
            {
                ...
                <AnimatedFromRight key={idx}>
                    <div className="w-full lg:w-[1000px] px-6 lg:mr-10 lg:ml-auto text-right">
